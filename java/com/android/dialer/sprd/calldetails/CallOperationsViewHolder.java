...
/**
 * ViewHolder for Header/Contact in {@link OldCallDetailsActivity}.
 */
public class CallOperationsViewHolder extends RecyclerView.ViewHolder
    ...
    // UNISOC: modify for bug709708、900405
    ...
    CallOperationsViewHolder(View container) {
        ...
        // UNISOC: modify for bug709708、900405
        mIsVoiceMail = ((OldCallDetailsActivity) mContext).isVoiceMailForSelectedItem();
    ...
    void updateContactInfo(DialerContact contact) {
        ...
        // UNISOC: 895153 it still show VideoCallIcon when close the volte 4g
        ...
        // add contact
        // UNISOC: modify for bug709708、900405
        if (!isUnknownCall && !mIsVoiceMail && TextUtils.isEmpty(contact.getNumberLabel())) {
        ...
        // UNISOC: modify for bug1054971, do not show IPCallIcon when emergencycall
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.ip_call_icon) {
            ...
            /**UNISOC: bug877517&708782 FEATURE_CALL_DETAIL_ACTIONS @{ */
        ...
        /** UNISOC: bug900273 Card one Unicom card two mobile, call record details to make a video call,
