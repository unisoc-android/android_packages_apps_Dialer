...
public class ListedNumberActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, View.OnClickListener,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUESET_CODE_SELECT_CONTACTS:
                contactPicked(data);
                if (mInputDialog != null) { // UNISOC: add for bug940902
                    mInputDialog.dismiss();
                    mInputDialog = null;
                }
                break;
    ...
    private void contactPicked(Intent data) {
        ...
        try {
            ...
            if (cursor != null) {
                ...
                // TODO: later name may be use; UNISOC bug1158392
    ...
    public void onShow(DialogInterface dialog) {
        // adjustDialog(); UNISOC: delete for bug1209772
        ...
        mEditText.setFilters(new InputFilter[]{new InputFilter.LengthFilter(100)}); //UNISOC: modify for bug1206069
        mEditText.requestFocus(); //add for bug1140019
...
//            mInputDialog.dismiss();
//            mInputDialog = null;
//        }  // UNISOC: modify for bug933886
    }

    @Override
    // UNISOC :add for bug933886
